...
const Pagination = forwardRef(
  ({ next, previous, totalItems, pageSize, activePage = 0 }, ref) => {
    ...
    return (
      <div className="flex flex-1 w-full gap-2 items-end justify-between p-sm border border-neutral-500 shadow-sm bg-gray-800  rounded-xl">
        <Button
          variant="outlined"
        ...
        <div className="flex flex-col items-start gap-xs sm:flex-row sm:items-center sm:gap-sm">
          <Chip
            ...
            size="sm"
            value={
              <span className="text-white lowercase">{totalItems} items</span>
            }
          />
